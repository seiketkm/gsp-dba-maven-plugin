...
EXEC sys.sp_addextendedproperty @name = N'Description', @value = N'NAME', @level0type = N'SCHEMA', @level0name = gspanother, @level1type = N'TABLE',  @level1name = C_TABLE, @level2type = N'COLUMN',  @level2name = NAME;
