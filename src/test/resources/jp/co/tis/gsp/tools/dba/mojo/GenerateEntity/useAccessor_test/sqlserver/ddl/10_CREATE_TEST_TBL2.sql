...
EXEC sys.sp_addextendedproperty @name = N'Description', @value = N'NAME', @level0type = N'SCHEMA', @level0name = gsptest, @level1type = N'TABLE',  @level1name = TEST_TBL2, @level2type = N'COLUMN',  @level2name = NAME;
